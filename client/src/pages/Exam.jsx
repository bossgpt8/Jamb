...
export default function Exam() {
  ...
  const allSubjects = [
    ...
    { id: 'agricultural science', name: 'Agricultural Science', icon: 'fa-seedling', color: 'green', tag: 'SCIENCE', count: '40 Questions' },
    { id: 'principles of accounts', name: 'Principles of Accounts', icon: 'fa-file-invoice-dollar', color: 'emerald', tag: 'COMMERCIAL', count: '40 Questions' },
    { id: 'history', name: 'History', icon: 'fa-scroll', color: 'brown', tag: 'ARTS', count: '40 Questions' },
    { id: 'islamic studies', name: 'Islamic Studies (IRS)', icon: 'fa-moon', color: 'teal', tag: 'ARTS', count: '40 Questions' },
    { id: 'hausa', name: 'Hausa', icon: 'fa-language', color: 'orange', tag: 'ARTS', count: '40 Questions' },
    { id: 'igbo', name: 'Igbo', icon: 'fa-language', color: 'red', tag: 'ARTS', count: '40 Questions' },
    { id: 'yoruba', name: 'Yoruba', icon: 'fa-language', color: 'green', tag: 'ARTS', count: '40 Questions' },
    { id: 'french', name: 'French', icon: 'fa-language', color: 'blue', tag: 'ARTS', count: '40 Questions' },
    { id: 'arabic', name: 'Arabic', icon: 'fa-language', color: 'yellow', tag: 'ARTS', count: '40 Questions' },
    { id: 'fine art', name: 'Fine Art', icon: 'fa-palette', color: 'pink', tag: 'ARTS', count: '40 Questions' },
    { id: 'music', name: 'Music', icon: 'fa-music', color: 'purple', tag: 'ARTS', count: '40 Questions' },
    { id: 'home economics', name: 'Home Economics', icon: 'fa-home', color: 'lime', tag: 'ARTS', count: '40 Questions' },
    { id: 'computer studies', name: 'Computer Studies', icon: 'fa-laptop', color: 'indigo', tag: 'SCIENCE', count: '40 Questions' },
    { id: 'physical and health education', name: 'Physical and Health Education (PHE)', icon: 'fa-running', color: 'cyan', tag: 'SCIENCE', count: '40 Questions' },
  ]
