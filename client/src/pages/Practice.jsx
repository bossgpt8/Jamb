...
export default function Practice() {
  ...
  const subjects = [
    ...
    { id: 'agricultural-science', name: 'Agricultural Science', icon: 'fa-seedling', color: 'green', tag: 'SCIENCE', desc: 'Crop Production, Animal Husbandry & Soil Science' },
    { id: 'principles-of-accounts', name: 'Principles of Accounts', icon: 'fa-file-invoice-dollar', color: 'emerald', tag: 'COMMERCIAL', desc: 'Bookkeeping, Financial Statements & Accounting Principles' },
    { id: 'history', name: 'History', icon: 'fa-scroll', color: 'brown', tag: 'ARTS', desc: 'Nigerian, African & World History' },
    { id: 'islamic-studies', name: 'Islamic Studies (IRS)', icon: 'fa-moon', color: 'teal', tag: 'ARTS', desc: 'Quran, Hadith & Islamic Jurisprudence' },
    { id: 'hausa', name: 'Hausa', icon: 'fa-language', color: 'orange', tag: 'ARTS', desc: 'Hausa Language, Literature & Culture' },
    { id: 'igbo', name: 'Igbo', icon: 'fa-language', color: 'red', tag: 'ARTS', desc: 'Igbo Language, Literature & Culture' },
    { id: 'yoruba', name: 'Yoruba', icon: 'fa-language', color: 'green', tag: 'ARTS', desc: 'Yoruba Language, Literature & Culture' },
    { id: 'french', name: 'French', icon: 'fa-language', color: 'blue', tag: 'ARTS', desc: 'French Language, Grammar & Comprehension' },
    { id: 'arabic', name: 'Arabic', icon: 'fa-language', color: 'yellow', tag: 'ARTS', desc: 'Arabic Language, Grammar & Literature' },
    { id: 'fine-art', name: 'Fine Art', icon: 'fa-palette', color: 'pink', tag: 'ARTS', desc: 'Drawing, Painting, Sculpture & Design' },
    { id: 'music', name: 'Music', icon: 'fa-music', color: 'purple', tag: 'ARTS', desc: 'Music Theory, History & Appreciation' },
    { id: 'home-economics', name: 'Home Economics', icon: 'fa-home', color: 'lime', tag: 'ARTS', desc: 'Food & Nutrition, Clothing & Management' },
    { id: 'computer-studies', name: 'Computer Studies', icon: 'fa-laptop', color: 'indigo', tag: 'SCIENCE', desc: 'Programming, Hardware & Software' },
    { id: 'phe', name: 'Physical and Health Education (PHE)', icon: 'fa-running', color: 'cyan', tag: 'SCIENCE', desc: 'Sports, Fitness & Health Science' },
  ]
